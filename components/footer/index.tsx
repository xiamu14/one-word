...
export default function Footer() {
  return (
    <footer className="flex flex-col justify-center items-start mx-auto w-full pb-8 px-6">
      <hr className="!w-full border-t-1 border-gray-200 dark:border-gray-800 mb-8" />
      <div className="w-full max-w-2xl mx-auto grid grid-cols-1 gap-4 pb-8 sm:grid-cols-3">
